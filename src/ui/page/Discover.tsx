...
const Discover_NewCard: React.FC<Card_interface> = ({ speciesDeatail }) => {
    return (
...
export const Discover_Card: React.FC<Card_interface> = ({ speciesDeatail }) => {
    return (
        <span className="mainShadow flex-shrink-0 w-[48%] h-fit flex flex-col gap-2.5 rounded-main px-2.5 py-5" onClick={speciesDeatail}>
            <span className="w-full h-[100px] flex justify-center-safe items-center-safe">
                <img src={Logo} className="!h-full" />
            </span>
