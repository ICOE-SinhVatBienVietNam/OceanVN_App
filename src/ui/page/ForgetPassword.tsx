        ...
        <div className="shadowForm h-fit w-full bg-white p-5 rounded-main flex flex-col gap-4">
            ...
            <span className="flex flex-col gap-1">
                ...
                <span className="relative w-full">
                    <input type="password" placeholder="Nhập mật khẩu mới..." className="w-full h-[40px] !text-csNormal border-[0.5px] border-lightGray px-2.5 rounded-small" />
            ...
            <span className="flex flex-col gap-1">
                ...
                <span className="relative w-full">
                    <input type="password" placeholder="Nhập lại mật khẩu..." className="w-full h-[40px] !text-csNormal border-[0.5px] border-lightGray px-2.5 rounded-small" />
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 absolute top-1/2 right-2.5 translate-y-[-50%]">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                        <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                    </svg>
            ...
            <span className="flex flex-col items-center-safe gap-3 mt-4">
                <button className="w-full h-[40px] bg-mainLightBlue text-white !rounded-small">Xác nhận</button>
